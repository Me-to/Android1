...
public class MainActivity extends Activity {
    ...
    String a;
    boolean i = false;
    ImageView imageViewzhu,imageViewmen;
...
void tan(){
    ...
    private void onclick() {
            ...
            public void onClick(View view) {
                try {
                    rfid.readSingleEpc(new SingleEpcListener() {
                        ...
                        public void onVal(String s) {
                            a = s;
                            if (sharedPreferences.getString("kahao", "null").equals("null")) {
                                et_mima.setText("   ");
                                Log.e(TAG, "1 ");
                                Toast.makeText(MainActivity.this, "未注册请进行注册", Toast.LENGTH_LONG).show();
                            } else {
                                tv_ka.setText(s);
                                Log.e(TAG, "2 ");
                                tv_name.setText(sharedPreferences.getString("name","null"));
                                tv_ka.setText(sharedPreferences.getString("kahao","null"));
                                tv_zhiwu.setText(sharedPreferences.getString("zhiwei","null"));
                                tv_dianhua.setText(sharedPreferences.getString("dianhua","null"));
        ...
        btn_kaimen.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (sharedPreferences.getString("kahao", "null").equals(a) && sharedPreferences.getString("mima", "null").equals(et_mima.getText().toString().trim())) {
                    Toast.makeText(MainActivity.this, "已开门，请进入", Toast.LENGTH_LONG).show();
                    imageViewmen.setImageResource(R.drawable.kaimen);
                    AnimationDrawable animation= (AnimationDrawable) imageViewmen.getDrawable();
                    animation.start();
                    ...
                    Toast.makeText(MainActivity.this, "请刷卡并输入密码", Toast.LENGTH_SHORT).show();
                    Log.e(TAG, "4");
                }
                    }
        });
